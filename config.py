...
USE_LOCAL_LOCI_DATATYPES_STATIC_JSON = os.environ.get('USE_LOCAL_LOCI_DATATYPES_STATIC_JSON')
if USE_LOCAL_LOCI_DATATYPES_STATIC_JSON is not None:
   if USE_LOCAL_LOCI_DATATYPES_STATIC_JSON == 'true' or USE_LOCAL_LOCI_DATATYPES_STATIC_JSON == 'True':
      USE_LOCAL_LOCI_DATATYPES_STATIC_JSON = CONFIG["USE_LOCAL_LOCI_DATATYPES_STATIC_JSON"] = True
   else:
      USE_LOCAL_LOCI_DATATYPES_STATIC_JSON = CONFIG["USE_LOCAL_LOCI_DATATYPES_STATIC_JSON"] = False
else:
   USE_LOCAL_LOCI_DATATYPES_STATIC_JSON = CONFIG["USE_LOCAL_LOCI_DATATYPES_STATIC_JSON"] = False
...
TEMPORAL_PG_HOST = os.environ.get('TEMPORAL_PG_HOST')
TEMPORAL_PG_PORT = os.environ.get('TEMPORAL_PG_PORT')
TEMPORAL_PG_DB_NAME = os.environ.get('TEMPORAL_PG_DB_NAME')
TEMPORAL_PG_USER = os.environ.get('TEMPORAL_PG_USER')
TEMPORAL_PG_PASSWORD = os.environ.get('TEMPORAL_PG_PASSWORD')
TEMPORAL_CONN_STRING = 'postgresql://{}:{}@{}:{}/{}'.\
    format(TEMPORAL_PG_USER, TEMPORAL_PG_PASSWORD, TEMPORAL_PG_HOST, TEMPORAL_PG_PORT, TEMPORAL_PG_DB_NAME)
